...
#     let(:new_attributes) { { name: 'New Motorcycle Name' } }

#     context 'with valid params' do
#       it 'updates the requested motorcycle' do
#         put :update, params: { id: motorcycle.to_param, motorcycle: new_attributes }
#         motorcycle.reload
#         expect(motorcycle.name).to eq('New Motorcycle Name')
#       end

#       it 'renders a JSON response with the updated motorcycle' do
#         put :update, params: { id: motorcycle.to_param, motorcycle: new_attributes }
#         expect(response).to have_http_status(:ok)
#         expect(response.content_type).to eq('application/json')
#         expect(response.body).to include('New Motorcycle Name')
#       end
#     end

#     context 'with invalid params' do
#       it 'renders a JSON response with errors for the motorcycle' do
#         put :update, params: { id: motorcycle.to_param, motorcycle: invalid_attributes }
#         expect(response).to have_http_status(:unprocessable_entity)
#         expect(response.content_type).to eq('application/json')
#       end
#     end
